...
register_cuda_ci(est_time=1100, suite="stage-c-4-gpu-h200", labels=["megatron", "weight-update"])
register_rocm_ci(est_time=900, suite="stage-c-4-gpu-mi350", labels=["megatron", "weight-update"])
